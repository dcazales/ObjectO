	...
	//This one is attempting to calculate the weight points. 
	 ...
	 public static void getBloodPressure(ArrayList<Member>members) {
		 ...
		 for (Member member : members) {
			 ...
			 } else if ((bpSyst >=130) && (bpSyst <= 139)) {
				 //HighBlood Pressure  Systolic Stage 1
				 bloodPressure = 30;
			
			 }else if ((bpDias >=80) && (bpDias < 89)) {
				 //HighBlood Pressure Diastolic Stage 1
				 bloodPressure = 30;
			 
			 }else if ((bpSyst >=140) && (bpSyst < 180)) {
				 //Stage 2
				 bloodPressure = 75;
			 
			 }else if ((bpDias >=90) && (bpDias < 120)) {
				 //HighBlood Pressure Diastolic Stage2
				 bloodPressure = 750; 
